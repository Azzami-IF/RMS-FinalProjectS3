...
echo "[send_reminder_log] Selesai. Users diproses: {$processedUsers}; Skip preferensi: {$skippedPrefs}; In-app dibuat: {$inAppCreated}; Email terkirim: {$emailsSent}; Email skip (tanpa alamat): {$emailsSkippedNoAddress}; Ada rekomendasi: {$withRecommendation}.\n";
?>
