...
echo "[send_daily] Selesai. Users diproses: {$processedUsers}; In-app dibuat: {$inAppCreated}; Email terkirim: {$emailsSent}; Email skip (tanpa alamat): {$emailsSkippedNoAddress}.\n";
